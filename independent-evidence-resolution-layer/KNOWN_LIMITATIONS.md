...
- The evidence view does not grant permissions or prevent arbitrary actions. It
  ...
  component.
- Four automated review rounds found ten defects that earlier green checks did
...
Passing run 010 means only that no mismatch was observed in the specified 19
